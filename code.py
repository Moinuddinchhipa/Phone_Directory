...
Original file is located at
    https://colab.research.google.com/drive/17jMT-QuDo5CVVF0quLRgsOG_IjfCbicW
"""
...
# This function will delete all the entries in the phonebook 
def delete_all(pb):	
	return pb.clear()
...
# this function displays all content of phonebook 
def display_all(pb):
	if not pb:
		print("List is empty: []")
	else:
